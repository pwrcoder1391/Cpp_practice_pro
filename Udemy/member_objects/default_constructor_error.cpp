...
{   
    ...
    /* No Default constructor is mentioned here so there will be error if while initialization of 
    the object there will be no argument passed in the object */


        heros(int power) // overloaded constructor
        {
            name = "Batman";
            power = 2000;
            super_power = "Money";
